...
const NAV_ITEMS = [
  ...
  { label: 'Machines', view: 'Machines' },
  { label: 'Production', view: 'Production' },
  { label: 'Downtime', view: 'Downtime' },
  { label: 'OEE', view: 'OEE' },
